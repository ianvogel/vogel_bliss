...
if [ $genome == human ]; then
    ...
    refgen=/n/shared_db/bcbio/biodata/genomes/Hsapiens/GRCh37/bwa/GRCh37.fa # modify if necessary
fi
if [ $genome == mouse ]; then
    #CHANGE THIS TO THE CORRECT LOCATION/INDEX_BASENAME
    refgen=/n/shared_db/bcbio/biodata/genomes/Mmusculus/mm10/seq/mm10.fa # modify if necessary
fi
